		...
		if($permissions->google_username && $permissions->google_password){
			...
			if(!$gcal->client){				
				$msg_ext	=	' Your Google account is invalid. Please check Google username and password on My Account Settings';								
					...
					//$gcal->delete( "sj60pj8ipdvmlou3qfuh2abcu8_20130221T030000Z" ); 

					//get gcalid of this and following all elements in the series
					//delete from db and from gcal as well
					//create new element
					...
					//echo "</pre>";
					//activitiesv2::saveToGCal($activity2);
